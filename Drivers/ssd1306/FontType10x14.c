...
static uint8_t fontBitmap10x14[];


FontTypeDef FontType10x14 ={
    .StartChar = 10,
    .Height = 14,
    .Width = 10,
    .RowSapce = 2,
    .getFirstByteIndexOfChar = firstByteOfChar,
    .FontBitmap = fontBitmap10x14
};

static int firstByteOfChar(char ch)
{
  return ch * FontType10x14.Height * 2;
}
...
//A Symbolumok szélesebbek mint 10 karakter... ezt majd egyszer javítani kell
